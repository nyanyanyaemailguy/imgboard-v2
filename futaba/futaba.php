...
define("HOME",  './futaba.php');			//「ホーム」へのリンク
...
<tr>
  ...
  <td>
    ...
    '<button type="submit" class="g-recaptcha" data-sitekey="'.reCAPTCHA_SITE_KEY.'" data-callback="onSubmit" data-action="submit">送信する</button>').'
  </td></tr>
...
';}
$dat.='<tr><td bgcolor=#eeaa88><b>削除キー</b></td><td><input type=text name=pwd size=8 maxlength=8 value=""><small>(記事の削除用。英数字で8文字以内)</small></td></tr>
<tr><td colspan=2>
<small>
<ul>
  ...
  <li>公序良俗に反する一切の書き込みを禁じます。政治はだめ.</li>
  '.( reCAPTCHA_SITE_KEY == '' ? '' :
  ...
  <li>MathJax が使えます. inline は <code>\(\)</code>, block は <code>\[\]</code> で挟みます.</li>
</ul>
